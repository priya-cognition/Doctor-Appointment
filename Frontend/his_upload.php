      ...
      <tr>
        ...
        <td width="237"><label for="patient"></label>
          ...
          <?php 
			include("connection.php");
			$did=$_SESSION['id'];
				$stmt_pat = mysqli_prepare($con, "SELECT patient.patientID,pname FROM patient,appointment WHERE patient.patientID=appointment.patientID AND appointment.doctorID=? GROUP BY pname");
