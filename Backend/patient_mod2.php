...
function checkTime(i) {
  ...
  $stmt = mysqli_prepare($conn, "UPDATE patient SET pname=?, phone=?, address=?, password=?, pimage=? WHERE patientID=?");
  mysqli_stmt_bind_param($stmt, "ssssss", $pname, $phone, $address, $password, $imagef, $pid);
