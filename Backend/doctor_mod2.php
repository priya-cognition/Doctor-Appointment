...
function checkTime(i) {
  ...
  $stmt = mysqli_prepare($conn, "UPDATE doctor SET dname=?, phoneno=?, address=?, password=?, dimage=? WHERE doctorID=?");
  mysqli_stmt_bind_param($stmt, "ssssss", $dname, $phone, $address, $password, $imagef, $did);
